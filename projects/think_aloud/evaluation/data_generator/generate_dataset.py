...
PAIRED_OPTIONS = {'[VERB] [VERB-OBJ]': ['read [READABLE]', 'drink [DRINKABLE]', 'eat [FOOD]', 'bake [FOOD]',
                                        'grab [OBJECT]', 'buy [OBJECT]', 'play sports'],
                  '[VERBS] [VERBS-OBJ]': ['reads [READABLE]', 'drinks [DRINKABLE]', 'eats [FOOD]', 'bakes [FOODS]',
                                          'grabs [OBJECT]', 'buys [OBJECT]'],
                  '[GERUND] [GERUND-OBJ]': ['reading [READABLE]', 'walking [ANIMAL]', 'cleaning [OBJECT]',
                                            'baking [FOODS]', 'watching movies']}

SINGLE_OPTIONS = {'[NAME]': ['Mike', 'Thomas', 'James', 'Serena', 'Alex', 'Bob', 'Charlie'],
                  ...
                  '[ACTIVITY]': ['talking', 'reading', 'exercising', 'walking', 'swimming', 'running', 'learning'],
                  '[OBJECT]': ['laptop', 'chair', 'bottle', 'camera', 'robot', 'cup', 'tree', 'book', 'car'],
                  '[OBJECTS]': ['laptops', 'chairs', 'drinks', 'cameras', 'robots', 'trees', 'books', 'car'],
                  ...
                  '[QUALITY]': ['beautiful', 'healthy', 'gorgeous', 'happy', 'polite', 'brave', 'scary'],
                  '[INSTITUTION]': ['university', 'school', 'college'],
                  '[PROFESSIONS]': ['teacher', 'accountant', 'barber', 'waiter', 'pilot', 'athlete', 'artist']}
