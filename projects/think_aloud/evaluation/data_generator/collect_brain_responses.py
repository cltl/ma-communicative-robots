...
def collect_brain_responses(args):
    ...
    brain_response_file = os.path.dirname(os.path.abspath(args.eval_data)) + '/brain_responses/br_{}.json'
...
if __name__ == "__main__":
    ...
    parser.add_argument('--eval_data', default='eval_contexts.txt', type=str,
