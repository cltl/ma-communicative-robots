...
def get_the_most_similar(sent1, cand_list, model=model):  # model = SentenceTransformer("multi-qa-mpnet-base-dot-v1")
    ...
    explanation = sorted(similarity_dict.items(), key=lambda item: item[1], reverse=True)
