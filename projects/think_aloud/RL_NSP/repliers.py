...
class Replier(BasicReplier):
    ...
    def phrase_all_conflicts(self, conflicts, speaker=None):
        """Phrases the existence of conflicts generated by the brain.

        params
        dict conflicts: list of available conflicts
        ...
        if len(conflict["objects"]) > 1:
            ...
            options = [
                "%s %s like %s told me" % (predicate, item["value"], item["author"])
                for item in conflict["objects"]
            ]
            options = " or ".join(options)
            subject = self._replace_pronouns(
                speaker,
                author=conflict["objects"][1]["author"],
    ...
    def _phrase_cardinality_conflicts(conflicts, utterance):
        ...
        params
        list conflicts: list of cardinality conflict thoughts
        dict utterance: parse of input utterance
    ...
    def _phrase_negation_conflicts(conflicts, utterance):
        ...
        params
        list conflicts: list of negation conflict thoughts
        dict utterance: parse of input utterance
    ...
    def _phrase_statement_novelty(prev_claims, utterance):
        ...
        params
        list prev_claims: list of previously made claims identical to the utterance
        dict utterance:   parse of input utterance
    ...
    def _phrase_entity_novelty(self, novelties, utterance):
        ...
        params
        list novelties: list of entity novelty thoughts
        dict utterance: parse of input utterance
        ...
        if entity_role != "none":
            ...
            if entity_label != "you":
                # Checked
                say += " I have heard about %s before" % self._replace_pronouns(
                    utterance["author"], entity_label=entity_label, role="object"
                )
            else:
    ...
    def _phrase_subject_gaps(all_gaps, utterance):
        ...
        params
        list all_gaps:  list of subject gap thoughts
        dict utterance: parse of input utterance
    ...
    def _phrase_complement_gaps(all_gaps, utterance):
        ...
        params
        list all_gaps:  list of object/complement gap thoughts
        dict utterance: parse of input utterance
    ...
    def _phrase_overlaps(all_overlaps, utterance):
        ...
        params
        list all_overlaps: list of single and paired overlap thoughts
        dict utterance:    parse of input utterance
    ...
    def _phrase_trust(trust):
        """Phrases the trust of the robot with respect to the speaker.
    ...
    def reply_to_question(self, brain_response):
        ...
        for item in response:
            ...
            # INITIALIZATION
            subject, predicate, object_ = self._assign_spo(utterance, item)
            ...
            object_ = self._replace_pronouns(
                utterance["author"], entity_label=object_, role="object"
            )

            subject = self._fix_entity(subject, utterance["author"])
            object_ = self._fix_entity(object_, utterance["author"])

            # Hash item such that duplicate entries have the same hash
            item_hash = "{}_{}_{}_{}".format(subject, predicate, object_, author)
    ...
    def _assign_spo(utterance, item):
        ...
        if (
            ...
            object_ = item["olabel"]["value"]
        else:
            object_ = utterance["object"]["label"]
...
class LenkaReplier(Replier):
    ...
    def __init__(self, brain, savefile=None):
        ...
        self.__brain = brain
        self.__thought_selector = self.RandomSelector()
