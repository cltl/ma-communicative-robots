...
from cltl.combot.backend.utils.casefolding import casefold_capsule, casefold_text
...
class Replier(BasicReplier):
    ...
    def reply_to_question(self, brain_response):
        ...
        for item in response:
            ...
            object_ = self._replace_pronouns(utterance['author'], entity_label=object_, role='object')
