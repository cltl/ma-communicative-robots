...
class PromptWrapper:
    ...
    def __init__(
        ...
        elif prompt.lower() == "episodic2sementichidde":
            self.prompt = Episodic2SementicHidde()
        ...
        elif prompt.lower() == "episodic2sementichiddereversed":
            self.prompt = Episodic2SementicHiddeReversed()
